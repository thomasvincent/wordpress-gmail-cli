...
namespace WordPressGmailCli\SocialAuth\Providers;
...
class ProviderFactory
{
    ...
    {
        $this->registerProvider('google', GoogleProvider::class);
         ...
         *
         * @param ProviderFactory $factory The provider factory instance.
         */
    ...
    public function createProvider(string $identifier, ?array $config = null): ProviderInterface
    {
        ...
        try {
            $provider = new $providerClass($providerConfig, $this->logger);
    ...
    public function getConfiguredProviders(): array
    {
        ...
        foreach (array_keys($this->providers) as $identifier) {
            try {
                ...
                // Skip providers with invalid configuration
                $this->logger->debug('Skipping unconfigured provider', [
                    'provider' => $identifier,
                    'reason' => $e->getMessage(),
                ]);
                continue;
